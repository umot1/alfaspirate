...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`:tools: **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(!kanal) return message.channel.send(`:tools: **Bu Özelliği Ayarlayabilmek İçin Bir Kanal Etiketlemelisin!**\n**__Örnek__**: ${prefix}kayıt-log-kanal-ayarla \`#kayıtLogKanal\``)
 
  message.channel.send(`:tools: **Kayıt Log Kanalı** \`${kanal}\` olarak ayarlandı! `)
