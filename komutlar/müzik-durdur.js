...
.setDescription(`:tools:  | Oynatılan bir müziği durdurabilmek için bir ses kanalında olmanız gerekmektedir!`)
...
.setColor(AloneDogru)
  .setTitle("Clarisa | Durdur")
.setDescription(`:tools:  | Müzikler ${message.author} tarafından durduruldu! Clarisa ses kanalından ayrılıyor.`) 
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL())
