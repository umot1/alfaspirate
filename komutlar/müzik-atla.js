...
.setDescription(`:tools:  **| Oynatılan bir müziği geçebilmek için bir ses kanalında olmanız gerekmektedir!**`)
...
.setColor(AloneDogru) 
.setTitle("Clarisa | Atla")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`:tools:  **|** \`${sarki.name}\` **adlı müzik** ${message.author} **tarafından geçildi!**`) 
