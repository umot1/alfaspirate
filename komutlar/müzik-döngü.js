...
.setColor(AloneDogru)
.setTitle("Clarisa |  Döngü")
.setDescription(`:tools: | Müzik döngüsü, ${message.author} tarafından \`aktif\` edildi.`) 
...
.setColor(AloneDogru)
.setTitle("Clarisa | Döngü")
.setDescription(`:tools: | Müzik döngüsü, ${message.author} tarafından \`de-aktif\` edildi.`) 
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());  
...
.setTitle("• Hata: 008 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`:tools:  | Döngüyü ayarlayabilmek için bir ses kanalında olmanız gerekmektedir!`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());  
