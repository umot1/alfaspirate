...
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`);  
  ...
  if (!öneri) {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .setAuthor(":tools: Yeni Bir Öneri!", client.user.avatarURL())
 
      .addField(":tools: • Öneren Kullanıcı:", message.author.tag, true)
 
      .addField(":tools: • Öneren Kullanıcı ID:", message.author.id,true)
 
      .addField(":tools: • Önerisi:", öneri)
